...
execute if score #direction DGvar matches -2147483648 run setblock ~ ~ ~ structure_block{mode:"LOAD",name:"dg_templates:complex/rooms/blue",posX:4,posY:-1,posZ:7,rotation:"CLOCKWISE_180"}
#West facing junction
execute if score #direction DGvar matches -1073741824 run setblock ~ ~ ~ structure_block{mode:"LOAD",name:"dg_templates:complex/rooms/blue",posX:-7,posY:-1,posZ:4,rotation:"COUNTERCLOCKWISE_90"}
#North facing junction
execute if score #direction DGvar matches 0 run setblock ~ ~ ~ structure_block{mode:"LOAD",name:"dg_templates:complex/rooms/blue",posX:-4,posY:-1,posZ:-7,rotation:"NONE"}
#East facing junction
execute if score #direction DGvar matches 1073741824 run setblock ~ ~ ~ structure_block{mode:"LOAD",name:"dg_templates:complex/rooms/blue",posX:7,posY:-1,posZ:-4,rotation:"CLOCKWISE_90"}
