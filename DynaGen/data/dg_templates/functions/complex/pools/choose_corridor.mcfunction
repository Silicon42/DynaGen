...
execute if score #junctionSeed DGvar matches 0..2 run function dg_templates:complex/substructures/long_corridor
execute if score #junctionSeed DGvar matches 3 run function dg_templates:complex/substructures/short_corridor
execute if score #junctionSeed DGvar matches 4 run function dg_templates:complex/substructures/t_corridor