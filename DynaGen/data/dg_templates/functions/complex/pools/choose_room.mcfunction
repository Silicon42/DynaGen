...
execute if score #junctionSeed DGvar matches 0..2 run function dg_templates:complex/substructures/rooms/red
execute if score #junctionSeed DGvar matches 3..6 run function dg_templates:complex/substructures/rooms/blue
